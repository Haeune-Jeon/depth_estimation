...
LABEL_DIR = os.path.join(CURRENT_DIR, "..", "sample_dataset", "labels")
IMAGE_DIR = os.path.join(CURRENT_DIR, "..", "sample_dataset", "images")
...
def register_sample():
    ...
    DatasetCatalog.register("sample_train",
                            lambda: load_custom_dataset(LABEL_DIR, IMAGE_DIR, category_name_to_id)
    )
    MetadataCatalog.get("sample_train").set(
