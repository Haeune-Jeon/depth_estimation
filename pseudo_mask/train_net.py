...
# sample dataset
#import register_sample_dataset
#register_sample_dataset.register_sample()

# entire dataset
import register_dataset
register_dataset.register_finetuning_dataset()
...
# sample daataset
# from register_sample_dataset import generate_category_name_to_id
# entire dataset
from register_dataset import generate_category_name_to_id
...
def setup(args):
    ...
    # cfg.merge_from_file("sample_config.yaml")  # sampe dataset
    # entire dataset
    cfg.merge_from_file("cityscape_config.yaml")
    
    # label_dir = os.path.join(os.path.dirname(__file__), "..", "sample_dataset", "labels")  # sample dataset
    label_dir = os.path.join(os.path.dirname(__file__), "..", "datasets", "labels_bbox")  # entire dataset
    category_name_to_id = generate_category_name_to_id(label_dir)
    
    cfg.MODEL.ROI_HEADS.NUM_CLASSES = len(category_name_to_id)
    
    # register_sample_dataset과 중복
    MetadataCatalog.get("FineTunin_train").set(
